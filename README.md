...
4. In the app: **Settings → Sync between phones**, paste both, tap
   **Save & test connection**. You should get a green ✓.
   (Whose phone it is and the Both of us / Per person toggle stay on each phone —
   only the budget, the expenses and the trip dates are shared.)
...
- **Who paid** — the two of you are Tanguy and Zita, and those are the only options
  anywhere in the app. Settings asks only **whose phone is this**, which stamps who
